...
class ShoppingList extends React.Component {
  ...
  handleD3(event) {
    ...
    const url =
      'https://999999.best/.netlify/functions/captions?v=' +
      currentVideoId +
      '&l=' +
      currentLanguage;
      ...
      <div className="shopping-list">
        ...
        <label>
          ...
          <input
            ...
            maxLength="200"
            size="60"
            placeholder="Input Youtube video id: 9KiUq8i9pbE"
            value={this.state.defaultVideoUrl}
            onChange={this.handleVideoChange}
          />
          &nbsp;&nbsp;
          <a target="blank" href={this.state.defaultVideoUrl}>
            youtube
          </a>
        </label>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;Get Language: &nbsp;&nbsp;
        <button type="button" value="en" onClick={this.handleLanuageChange}>
          English
        </button>
        &nbsp;&nbsp;
        <button type="button" value="zh-CN" onClick={this.handleLanuageChange}>
          Chinese
        </button>
        <br />
        <br />
        ...
        <button type="button" onClick={this.handleD3} value="111" hidden>
          Click Me!
        </button>
      </div>
    );
